...
function App() {
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      {/* Left Section */}
      <div className="bg-black w-full md:w-1/3 flex flex-col justify-between p-10 text-white relative z-10">
        <div className="space-y-5">
          <h1 className="text-3xl font-bold">PORTFOLIO</h1>
        </div>
        {/* Adjusted to move content more towards the left and higher from the bottom */}
        <div className="flex flex-col items-start absolute bottom-40 left-10 md:left-40 space-y-5">
          <div className="flex flex-col">
            <h2 className="text-3xl md:text-5xl font-bold">My Name Is</h2>
      ...
      <div className="relative w-full md:w-2/3">
        ...
        {/* Navbar */}
        <header className="absolute top-0 right-0 left-0 flex justify-center space-x-4 md:space-x-8 text-white p-5 md:p-10 bg-transparent z-20">
